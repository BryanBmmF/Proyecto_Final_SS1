...
**/
drop database if exists portal_ventas;
create database portal_ventas;
use portal_ventas;
...
create table user(
	...
	created_at datetime,
    username_pp varchar(300),
    password_pp varchar(35)
);
...
insert into country (name) value ("Espa̱a");
...
insert into paymethod(short_name,name) value ("portal_pagos", "Portal de Pagos"),("deliver", "Pago Contra entrega");
